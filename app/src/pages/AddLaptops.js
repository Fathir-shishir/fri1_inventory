...
const AddLaptops = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        condition: '',
        quantities: '',
        LaptopHistory: sessionState.name // Use sessionState.name as the initial value
    });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('api/addLaptops.php', formData, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setFormData({
                    ...
                    condition: '',
                    quantities: '',
                    createdBy: sessionState.name || '' // Reset with sessionState.name
                });
    ...
    return (
        <Layout>
            <h1 className="text-center font-semibold p-3 text-4xl">Add Laptop </h1>
